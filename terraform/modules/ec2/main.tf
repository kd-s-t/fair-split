...
resource "aws_instance" "splitsafe_server" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "  docker run -d --name dfx --restart unless-stopped --cpus 1 --memory 1g --memory-swap 2g -p 4943:4943 -e DFX_NETWORK=local -v dfx_cache:/home/dfx/.cache -v dfx_config:/home/dfx/.config -v /home/ubuntu/dfxproj:/app -w /app fleek/dfx:latest dfx start --clean --host 0.0.0.0:4943",
