    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="container flex-1 !rounded-2xl !px-6 !py-4 text-white">
          ...
          {/* Escrow overview for released/completed state */}
          {statusKey === 'released' && (
            <div className="mb-8">
              <Typography variant="h4" className="mb-4">Escrow overview</Typography>
              ...
              <Typography variant="h4" className="mb-4">Payment distribution</Typography>
              <div className="flex flex-col gap-4">
