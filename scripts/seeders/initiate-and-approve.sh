...
# Step 4: Verify escrow is approved
echo "📋 Step 4: Verifying escrow is approved..."
...
# Summary
echo "🎉 InitiateAndApprove Seeder Summary:"
echo "📋 Escrow ID: $ESCROW_ID"
echo "💰 Amount: $ESCROW_AMOUNT satoshis (0.00004 BTC)"
echo "👤 Sender: $SENDER_PRINCIPAL"
echo "👥 Recipient: $RECIPIENT_PRINCIPAL (random)"
echo "👑 Admin: $ADMIN_PRINCIPAL"
echo "✅ Escrow successfully approved by recipient"
