...
resource "aws_instance" "splitsafe_server" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo apt-get install -y debian-keyring debian-archive-keyring apt-transport-https curl || true",
      "curl -1sSf https://dl.caddyserver.com/install.sh | sudo bash || true",
      ...
      "echo '✅ Caddy installed and configured for domain ${var.dfx_domain}'",
      "echo '======================================================================================'",
      "echo 'Installing Nginx (alternative reverse proxy)...'",
      "sudo apt install -y nginx",
      "sudo systemctl enable nginx",
      "sudo systemctl start nginx",
      "echo '✅ Nginx installed as alternative reverse proxy'",
      "echo '======================================================================================'",
